...
const EVENTS = [
 ...
 { id: "e9", title: "We had many wintery adventures!", date: "Winter 2024", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/WinterAdventures.png", side: "right", path: "merge", position: 0.82 },
 { id: "e10", title: "...and many warmer adventures!", date: "Spring & SUmmer 2025", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/SummerAdventures.png", side: "left", path: "merge", position: 0.82 },
 ...
 { id: "e12", title: "Proposal in Central Park rowboats by the Loeb Boathouse, with friends in on the surprise!", date: "July 19, 2025", desc: "Thank you Brooke and Ryan ;)", icon: <Heart className="w-4 h-4" />, img: "/images/Proposal.png", side: "merge", path: "merge", position: 0.82 },
