...
const EVENTS = [
 ...
 { id: "e6", title: "pending", date: "2019", desc: "Melissa graduates from UPenn in school psychology, Constantine from CCNY in structural engineering, just like Melissa's father did in 1987 (Constantine's birthday!)", icon: <MapPin className="w-4 h-4" />, img: "/images/CCNY&UPenn.png", side: "right", path: "you", position: 0.58 },
