...
const EVENTS = [
 ...
 { id: "e4", title: "Galapágos school program", date: "Winter 2009 (C) & Summer 2009 (M)", desc: "We both visited the Galápagos Islands for school programs just a few months apart.", icon: <Camera className="w-4 h-4" />, img: "/images/IMG_6697.png", side: "right", path: "you", position: 0.38 },
 { id: "e5", title: "College years", date: "2010 (C) & 2014 (M)", desc: "And then we both pivoted from architecture — Constantine to engineering, Melissa to school psychology.  Melissa went on to graduate from UPenn, Constantine from CCNY in engineering, just like Melissa’s father did in 1987 (Constantine's birthday!)", icon: <Camera className="w-4 h-4" />, img: "/images/CCNY&UPenn.png", side: "left", path: "you", position: 0.48 },
