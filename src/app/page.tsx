...
const EVENTS = [
 ...
 { id: "e8", title: "First date - we finally meet!", date: "Oct 28, 2024: Mareluna, Flatiron.", desc: "The day we met, Constantine’s fridge and phone died (spooky omen / cosmic reset?). The waiters never came by to ask us how we were doing.", icon: <Heart className="w-4 h-4" />, img: "/images/FirstDate.png", side: "merge", path: "merge", position: 0.82 },
 { id: "e9", title: "Winter adventures!", date: "Winter 2024", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/WinterAdventures.png", side: "right", path: "merge", position: 0.82 },
 ...
 { id: "e11", title: "Our first trip together!", date: "2025-07-19", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/FirstTrip.png", side: "right", path: "merge", position: 0.82 },
 { id: "e12", title: "The proposal: Central Park rowboats by the Loeb Boathouse, with friends in on the surprise.", date: "2025-07-19", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/Proposal.png", side: "merge", path: "merge", position: 0.82 },
 { id: "e13", title: "Save the Date!", date: "3/29 Beacon, NY", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images//Constantine&Melissa.png", side: "merge", path: "merge", position: 0.82 },
