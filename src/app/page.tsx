...
const EVENTS = [
 ...
 { id: "e3", title: "Art & Architecture", date: "Pre-2010 (C) & Pre-2014 (M)", desc: "Both of us studied architecture briefly, before pivoting (him to engineering, her to be a school psychologist)", icon: <Camera className="w-4 h-4" />, img: "/images/Art&Arch.png", side: "left", path: "partner", position: 0.28 },
 ...
 { id: "e5", title: "Wepa!", date: "2019", desc: "Constantine studied in the DR during grad school, working with FUNGLODE - there he had made his mind up about Dominicanas.", icon: <MapPin className="w-4 h-4" />, img: "/images/DominicanRepublic.png", side: "left", path: "you", position: 0.48 },
 { id: "e6", title: "pending", date: "2019", desc: "Melissa graduated as a school psych - Constantine as a structural engineer from CCNY, just like Melissa's father did in 1987 (Constantine's birthday!)", icon: <MapPin className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200", side: "right", path: "you", position: 0.58 },
 { id: "e7", title: "Graduate school missed connection", date: "2017 (C) & 2022 (M)", desc: "Both of us went to Columbia University – we graduated five years apart from one another!", icon: <Camera className="w-4 h-4" />, img: "/images/ColumbiaGrad.png", side: "left", path: "partner", position: 0.68 }, 
 ...
 { id: "e9", title: "First date (we finally meet)", date: "2022-06-18", desc: "The day we met, Constantine’s fridge and phone died – spooky omen / cosmic reset?.", icon: <Heart className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?w=1200", side: "merge", path: "merge", position: 0.82 },
 { id: "e10", title: "The proposal: Central Park rowboats by the Loeb Boathouse, with friends in on the surprise.", date: "2025-07-19", desc: "", icon: <Heart className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1519741497674-611481863552?w=1200", side: "merge", path: "merge", position: 0.82 },
 ...
 { id: "e15", title: "Constantine kept proposing....", date: "2025-07-19", desc: "He never gave up", icon: <Heart className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1519741497674-611481863552?w=1200", side: "merge", path: "merge", position: 0.82 },
 { id: "e16", title: "Constantine & Melissa", date: "2025-07-19", desc: "You're Welcome.", icon: <Heart className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1519741497674-611481863552?w=1200", side: "merge", path: "merge", position: 0.82 },
 ];
