...
const EVENTS = [
 ...
 { id: "e12", title: "And then Constantine proposed on the Central Park rowboats by the Loeb Boathouse, with Melissa's friends in on the surprise!", date: "July 19, 2025", desc: "Thank you Brooke and Ryan ;)", icon: <Heart className="w-4 h-4" />, img: "/images/Proposal.png", side: "merge", path: "merge", position: 0.82 },
