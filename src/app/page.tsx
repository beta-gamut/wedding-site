...
const EVENTS = [
 ...
 { id: "e3", title: "Missed connection #3", date: "December 2016 (C) & March 2017 (M)", desc: "both visited the Galápagos Islands for school programs, months apart, each of us meeting the eponymous Lonesome George at the Darwin Center - we felt his loneliness.", icon: <MapPin className="w-4 h-4" />, img: "/images/IMG_6697.png", side: "left", position: 0.28 },
