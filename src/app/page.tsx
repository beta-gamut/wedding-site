...
const EVENTS = [
 { id: "e1", title: "Childhood in Queens", date: "1987 (C) & 1992 (M)", desc: "We played in the same playgrounds in Elmhurst.", icon: <MapPin className="w-4 h-4" />, img: "/images/children.png", side: "left", path: "you", position: 0.08 },
 { id: "e2", title: "NYC High School missed connection", date: "Pre-2005 (C) & Pre-2010 (M)", desc: "We were too awkward to have met in HS...", icon: <MapPin className="w-4 h-4" />, img: "/images/516193714_10162281456903037_4098486317061675322_n.png", side: "right", path: "you", position: 0.18 },
 { id: "e3", title: "Art & Architecture", date: "Pre-2010 (C) & Pre-2014 (M)", desc: "We were both moody artists", icon: <Camera className="w-4 h-4" />, img: "/images/Art&Arch.png", side: "left", path: "partner", position: 0.28 },
 { id: "e4", title: "Galapagos missed connection", date: "Winter 2009 (C) & Summer 2009 (M)", desc: "both visited the Galápagos Islands for school programs, just a few months apart, each of us meeting the eponymous Lonesome George at the Darwin Center - we felt his loneliness.", icon: <MapPin className="w-4 h-4" />, img: "/images/IMG_6697.png", side: "right", path: "you", position: 0.38 },
 { id: "e5", title: "College years", date: "2010 (C) & 2014 (M)", desc: "Both of us studied architecture briefly, before pivoting (him to engineering, her to be a school psychologist) - Melissa graduates from UPenn, Constantine from CCNY in structural engineering, just like Melissa's father did in 1987 (Constantine's birthday!)", icon: <MapPin className="w-4 h-4" />, img: "/images/CCNY&UPenn.png", side: "left", path: "you", position: 0.48 },
 ...
 { id: "e7", title: "Graduate school missed connection!!", date: "2017 (C) & 2022 (M)", desc: "Both of us went to Columbia University – we graduated five years apart from one another!", icon: <Camera className="w-4 h-4" />, img: "/images/ColumbiaGrad.png", side: "left", path: "partner", position: 0.70 }, 
 //{ id: "e8", title: "pending", date: "2022 & 2023", desc: "We were tutors and teaching in the Bronx but still didn't meet.", icon: <Camera className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1541167760496-1628856ab772?w=1200", side: "right", path: "partner", position: 0.75 },
 { id: "e8", title: "We finally meet!", date: "Oct 28, 2024: Mareluna, Flatiron.", desc: "The day we met, Constantine’s fridge and phone died (spooky omen, or cosmic reset?). The waiters also never came by to ask us how we were doing.", icon: <Heart className="w-4 h-4" />, img: "/images/FirstDate.png", side: "merge", path: "merge", position: 0.82 },
 { id: "e9", title: "We then had many wintery adventures...", date: "Winter 2024", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/WinterAdventures.png", side: "right", path: "merge", position: 0.82 },
 { id: "e10", title: "...and warmer adventures!", date: "Spring & Summer 2025", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/SummerAdventures.png", side: "left", path: "merge", position: 0.82 },
 { id: "e11", title: "We took our first trip together to Peru", date: "Apr 13–20, 2025", desc: "We packed in so much on little sleep, and didn't argue once!", icon: <Heart className="w-4 h-4" />, img: "/images/FirstTrip.png", side: "right", path: "merge", position: 0.82 },
 { id: "e12", title: "And then Constantine proposed on the Central Park rowboats by the Loeb Boathouse, with Melissa's friends unknowingly enlisted as part of the surprise!", date: "July 19, 2025", desc: "Thank you Brooke and Ryan ;)", icon: <Heart className="w-4 h-4" />, img: "/images/Proposal.png", side: "merge", path: "merge", position: 0.82 },
 { id: "e13", title: "Save the Date!", date: "3/29 Beacon, NY", desc: "See you there!!", icon: <Heart className="w-4 h-4" />, img: "/images//Constantine&Melissa.png", side: "merge", path: "merge", position: 0.82 },
 // { id: "e10", title: "Constantine kept proposing....", date: "2025-07-19", desc: "He never gave up", icon: <Heart className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1519741497674-611481863552?w=1200", side: "merge", path: "merge", position: 0.82 },
...
// { id: "e15", title: "Constantine & Melissa", date: "2025-07-19", desc: "You're Welcome.", icon: <Heart className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1519741497674-611481863552?w=1200", side: "merge", path: "merge", position: 0.82 },
 ];
  ...
  <CardContent className="p-5 md:p-7">
    ...
    <div className="mt-4 overflow-hidden rounded-xl">
      <img
        src={e.img}
        alt={e.title}
        className="w-full h-auto"              //CHANGED: was h-56 object-cover
        loading="lazy"
        decoding="async"
        onLoad={isFirstDate ? measureMergeStart : undefined} // keep your measurement
        onError={(ev) => {
          // optional: helps catch any bad paths during dev
          console.warn("Image failed:", (ev.currentTarget as HTMLImageElement).src);
        }}
      />
    </div>
