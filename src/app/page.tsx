...
const EVENTS = [
 ...
 { id: "e3", title: "Galapagos missed connection", date: "Winter 2009 (C) & Summer 2009 (M)", desc: "both visited the Galápagos Islands for school programs, just a few months apart, each of us meeting the eponymous Lonesome George at the Darwin Center - we felt his loneliness.", icon: <MapPin className="w-4 h-4" />, img: "/images/IMG_6697.png", side: "left", path: "you", position: 0.28 },
 { id: "e4", title: "Graduate school missed connection", date: "2017 (C) & 2022 (M)", desc: "Both of us went to Columbia University – both studying architecture briefly, before pivoting (him to engineering, her to be a school psychologist). We graduated five years apart from one another", icon: <Camera className="w-4 h-4" />, img: "/images/graduation.png", side: "left", path: "partner", position: 0.38 },
 { id: "e5", title: "Missed connection #4", date: "2019", desc: "Melissa is Dominican; Constantine studied in the Dominican Republic during grad school. Constantine worked with FUNGLODE in the DR - he had made his mind up about Dominicanas.", icon: <MapPin className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200", side: "left", path: "you", position: 0.48 },
 { id: "e6", title: "Missed connection #5", date: "2019", desc: "We missed each other in the Galapagos Isles by a few months.", icon: <MapPin className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200", side: "left", path: "you", position: 0.58 },
 { id: "e7", title: "Missed connection #6 - Lonely Tutelage", date: "2022 & 2023", desc: "We were tutors and teaching in the Bronx but still didn't meet.", icon: <Camera className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1541167760496-1628856ab772?w=1200", side: "right", path: "partner", position: 0.65 },
 { id: "e8", title: "First date (we finally meet)", date: "2022-06-18", desc: "The day we met, Constantine’s fridge and phone died – spooky omen / cosmic reset?.", icon: <Heart className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?w=1200", side: "merge", path: "merge", position: 0.82 },
 { id: "e9", title: "The proposal: Central Park rowboats by the Loeb Boathouse, with friends in on the surprise.", date: "2025-07-19", desc: "", icon: <Heart className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1519741497674-611481863552?w=1200", side: "merge", path: "merge", position: 0.82 },
