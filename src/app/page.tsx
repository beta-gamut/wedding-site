...
const EVENTS = [
 ...
 { id: "e5", title: "College Years", date: "2010 (C) & 2014 (M)", desc: "Pivoting from architecture (him to engineering, her to be a school psychologist), Melissa graduates from UPenn, Constantine from CCNY in structural engineering - just like Melissa's father did in 1987 (Constantine's birthday!)", icon: <Camera className="w-4 h-4" />, img: "/images/CCNY&UPenn.png", side: "left", path: "you", position: 0.48 },
