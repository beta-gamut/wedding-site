...
const EVENTS = [
 ...
 { id: "e9", title: "Winter Adventures!", date: "2025-07-19", desc: "", icon: <Heart className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1519741497674-611481863552?w=1200", side: "merge", path: "merge", position: 0.82 },
 { id: "e10", title: "Our first trip together!", date: "2025-07-19", desc: "", icon: <Heart className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1519741497674-611481863552?w=1200", side: "merge", path: "merge", position: 0.82 },
 { id: "e11", title: "The proposal: Central Park rowboats by the Loeb Boathouse, with friends in on the surprise.", date: "2025-07-19", desc: "", icon: <Heart className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1519741497674-611481863552?w=1200", side: "merge", path: "merge", position: 0.82 },
 { id: "e12", title: "Save the Date!", date: "3/29 Beacon, NY", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images//Constantine&Melissa.png", side: "merge", path: "merge", position: 0.82 },
