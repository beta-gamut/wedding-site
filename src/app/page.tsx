...
const EVENTS = [
 ...
 { id: "e11", title: "We took our first trip together to Peru", date: "Apr 13–20, 2025", desc: "Packing in so much on little to no sleep, and not arguing once!", icon: <Heart className="w-4 h-4" />, img: "/images/FirstTrip.png", side: "right", path: "merge", position: 0.82 },
 ...
 { id: "e13", title: "See you there!", date: "3/29/2026 - Beacon, NY", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/Constantine&Melissa.png", side: "merge", path: "merge", position: 0.82 },
