...
const EVENTS = [
 ...
 { id: "e4", title: "Wepa!", date: "2019", desc: "Constantine studied in the DR during grad school, working with FUNGLODE - there he had made his mind up about Dominicanas.", icon: <MapPin className="w-4 h-4" />, img: "/images/DominicanRepublic.png", side: "right", path: "you", position: 0.38 },
 { id: "e5", title: "Graduate school missed connection", date: "2017 (C) & 2022 (M)", desc: "Both of us went to Columbia University – both studying architecture briefly, before pivoting (him to engineering, her to be a school psychologist). We graduated five years apart from one another", icon: <Camera className="w-4 h-4" />, img: "/images/graduation.png", side: "left", path: "partner", position: 0.48 },
