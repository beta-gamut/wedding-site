...
const EVENTS = [
 { id: "e1", title: "Who We Are", date: "1987 (C) & 1992 (M)", desc: "We both grew up in Queens, spending time in the same neighborhoods without ever meeting. Our paths ran close throughout schools in New York City, similar early creative pursuits in art and architecture, and later through parallel journeys in college and graduate school. Even as we each shifted into different careers, into engineering and school psychology, we shared similar milestones, often only a few steps apart, until we finally crossed paths years later.", icon: <Camera className="w-4 h-4" />, img: "/images/children.png", side: "merge", path: "you", position: 0.08 },
 ...
 { id: "e2", title: "NYC High School", date: "Pre-2005 (C) & Pre-2010 (M)", desc: "", icon: <MapPin className="w-4 h-4" />, img: "/images/516193714_10162281456903037_4098486317061675322_n.png", side: "right", path: "you", position: 0.18 },
 ...
 { id: "e4", title: "Galapagos School Program", date: "Winter 2009 (C) & Summer 2009 (M)", desc: "", icon: <MapPin className="w-4 h-4" />, img: "/images/IMG_6697.png", side: "right", path: "you", position: 0.38 },
 { id: "e5", title: "College Years", date: "2010 (C) & 2014 (M)", desc: "Pivoting from architecture (him to engineering, her to be a school psychologist), Melissa graduates from UPenn, Constantine from CCNY in structural engineering - just like Melissa's father did in 1987 (Constantine's birthday!)", icon: <MapPin className="w-4 h-4" />, img: "/images/CCNY&UPenn.png", side: "left", path: "you", position: 0.48 },
...
// { id: "e9", title: "Our First Date", date: "Oct 28, 2024: Mareluna, Flatiron.", desc: "Constantine’s fridge and phone dies (spooky omen or cosmic reset?)", icon: <Heart className="w-4 h-4" />, img: "/images/FirstDate.png", side: "merge", path: "merge", position: 0.82 },
 { id: "e8", title: "Wintery Adventures...", date: "Winter 2024", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/WinterAdventures.png", side: "right", path: "merge", position: 0.82 },
