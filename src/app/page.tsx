...
const EVENTS = [
 ...
 { id: "e3", title: "Art & Architecture Peculiarities", date: "Pre-2005 (C) & Pre-2010 (M)", desc: "Both studying architecture briefly, before pivoting (him to engineering, her to be a school psychologist)", icon: <Camera className="w-4 h-4" />, img: "/images/Art&Arch.png", side: "left", path: "partner", position: 0.28 },
 ...
 { id: "e6", title: "Graduate school missed connection", date: "2017 (C) & 2022 (M)", desc: "Both of us went to Columbia University – we graduated five years apart from one another!", icon: <Camera className="w-4 h-4" />, img: "/images/graduation.png", side: "right", path: "partner", position: 0.58 },
 { id: "e7", title: "Missed connection #5", date: "2019", desc: "We missed each other in the Galapagos Isles by a few months.", icon: <MapPin className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200", side: "left", path: "you", position: 0.68 },
 { id: "e8", title: "Missed connection #6 - Lonely Tutelage", date: "2022 & 2023", desc: "We were tutors and teaching in the Bronx but still didn't meet.", icon: <Camera className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1541167760496-1628856ab772?w=1200", side: "right", path: "partner", position: 0.75 },
