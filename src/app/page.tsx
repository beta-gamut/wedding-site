...
const EVENTS = [
 ...
 { id: "e5", title: "College years", date: "2010 (C) & 2014 (M)", desc: "Melissa graduates from UPenn in school psychology, Constantine from CCNY in structural engineering, just like Melissa's father did in 1987 (Constantine's birthday!)", icon: <MapPin className="w-4 h-4" />, img: "/images/CCNY&UPenn.png", side: "left", path: "you", position: 0.48 },
