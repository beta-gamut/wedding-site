...
const EVENTS = [
 ...
 { id: "e13", title: "See you there!", date: "3/29/2027 - Beacon, NY", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images//Constantine&Melissa.png", side: "merge", path: "merge", position: 0.82 },
