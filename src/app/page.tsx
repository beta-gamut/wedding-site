...
const EVENTS = [
  ...
  { id: "e2", title: "Graduate school missed connection", date: "2017 & 2022", desc: "Both of us went to Columbia University – both studying architecture briefly, before pivoting (him to engineering, her to be a school psychologist). We graduated five years apart from one another", icon: <Camera className="w-4 h-4" />, img: "/Graduation.png", side: "right", path: "partner", position: 0.18 },
  { id: "e3", title: "Missed connection #1", date: "December 2016 & March 2017", desc: "both visited the Galápagos Islands for school programs, months apart, each of us meeting the eponymous Lonesome George at the Darwin Center - we felt his loneliness.", icon: <MapPin className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200", side: "left", path: "you", position: 0.28 },
  { id: "e4", title: "Missed connection #2", date: "2019", desc: "Melissa is Dominican; Constantine studied in the Dominican Republic during grad school. Constantine worked with FUNGLODE in the DR - he had made his mind up about Dominicanas.", icon: <MapPin className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200", side: "left", path: "you", position: 0.28 },
