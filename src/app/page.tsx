...
const EVENTS = [
 ...
 { id: "e6", title: "Missed connection #5", date: "2019", desc: "We missed each other in the Galapagos Isles by a few months.", icon: <MapPin className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200", side: "left", path: "you", position: 0.28 },
 { id: "e7", title: "Missed connection #6 - Lonely Tutelage", date: "2022 & 2023", desc: "We were tutors and teaching in the Bronx but still didn't meet.", icon: <Camera className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1541167760496-1628856ab772?w=1200", side: "right", path: "partner", position: 0.45 },
 { id: "e8", title: "First date (we finally meet)", date: "2022-06-18", desc: "The day we met, Constantine’s fridge and phone died – spooky omen / cosmic reset?.", icon: <Heart className="w-4 h-4" />, img: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?w=1200", side: "merge", path: "merge", position: 0.62 },
