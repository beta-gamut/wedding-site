...
const EVENTS = [
 { id: "e1", title: "Childhood in Queens", date: "1987 (C) & 1992 (M)", desc: "We played in the same playgrounds in Elmhurst.", icon: <MapPin className="w-4 h-4" />, img: "/Children.png", side: "left", path: "you", position: 0.08 },
 { id: "e2", title: "Graduate school missed connection", date: "2017 (C) & 2022 (M)", desc: "Both of us went to Columbia University – both studying architecture briefly, before pivoting (him to engineering, her to be a school psychologist). We graduated five years apart from one another", icon: <Camera className="w-4 h-4" />, img: "/Graduation.png", side: "right", path: "partner", position: 0.18 },
