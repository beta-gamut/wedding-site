...
// { id: "e6", title: "Wepa!", date: "2019", desc: "Constantine studied in the DR during grad school, working with FUNGLODE - there he had made his mind up about Dominicanas.", icon: <MapPin className="w-4 h-4" />, img: "/images/DominicanRepublic.png", side: "right", path: "you", position: 0.58 },
 ...
 { id: "e8", title: "Our Shared Story", date: "Oct 28, 2024: Mareluna, Flatiron.", desc: "Before meeting, we unknowingly traveled to the same places, studied in the same school, and taught in the same part of the city. When we did finally met in 2024, it was immediately apparent that our stories have always been running side by side. The day of our first date, both Constantine’s fridge and phone die, making things extra spooky", icon: <Heart className="w-4 h-4" />, img: "/images/FirstDate.png", side: "merge", path: "merge", position: 0.82 },
// { id: "e9", title: "Our First Date", date: "Oct 28, 2024: Mareluna, Flatiron.", desc: "Constantine’s fridge and phone dies (spooky omen or cosmic reset?)", icon: <Heart className="w-4 h-4" />, img: "/images/FirstDate.png", side: "merge", path: "merge", position: 0.82 },
 { id: "e9", title: "Wintery Adventures...", date: "Winter 2024", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/WinterAdventures.png", side: "right", path: "merge", position: 0.82 },
 ...
 { id: "e11", title: "We Took Our First of Many Trips Together", date: "Apr 13–20, 2025", desc: "So much seen on so little sleep", icon: <Heart className="w-4 h-4" />, img: "/images/FirstTrip.png", side: "right", path: "merge", position: 0.82 },
 { id: "e12", title: "Our Shared Future", date: "July 19, 2025", desc: "On July 2025, we got engaged in Central Park, surrounded by friends and family who became part of the surprise (Photo credits to Brooke and Ryan!). Now, we look forward to celebrating with our loved ones at our wedding on March 2026 in Beacon, New York, and to continuing to build a life of shared adventures and laughter", icon: <Heart className="w-4 h-4" />, img: "/images/Proposal.png", side: "merge", path: "merge", position: 0.82 },
