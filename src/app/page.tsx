...
const EVENTS = [
 { id: "e1", title: "Who We Are", date: "", desc: "We both grew up in Queens, spending time in the same neighborhoods without ever meeting. Our paths ran close throughout schools in New York City, similar early creative pursuits in art and architecture, and later through parallel journeys in college and graduate school. Even as we each shifted into different careers, into engineering and school psychology, we shared similar milestones, often only a few steps apart, until we finally crossed paths years later.", icon: <MapPin className="w-4 h-4" />, img: "/images/children.png", side: "merge", path: "you", position: 0.08 },
 ...
 { id: "e3", title: "NYC High School", date: "Pre-2005 (C) & Pre-2010 (M)", desc: "", icon: <MapPin className="w-4 h-4" />, img: "/images/516193714_10162281456903037_4098486317061675322_n.png", side: "right", path: "you", position: 0.18 },
 { id: "e4", title: "Art & Architecture", date: "Pre-2010 (C) & Pre-2014 (M)", desc: "", icon: <Camera className="w-4 h-4" />, img: "/images/Art&Arch.png", side: "left", path: "partner", position: 0.28 },
 { id: "e5", title: "Galapagos School Program", date: "Winter 2009 (C) & Summer 2009 (M)", desc: "", icon: <MapPin className="w-4 h-4" />, img: "/images/IMG_6697.png", side: "right", path: "you", position: 0.38 },
 { id: "e6", title: "College Years", date: "2010 (C) & 2014 (M)", desc: "Pivoting from architecture (him to engineering, her to be a school psychologist), Melissa graduates from UPenn, Constantine from CCNY in structural engineering - just like Melissa's father did in 1987 (Constantine's birthday!)", icon: <MapPin className="w-4 h-4" />, img: "/images/CCNY&UPenn.png", side: "left", path: "you", position: 0.48 },
// { id: "e6", title: "Wepa!", date: "2019", desc: "Constantine studied in the DR during grad school, working with FUNGLODE - there he had made his mind up about Dominicanas.", icon: <MapPin className="w-4 h-4" />, img: "/images/DominicanRepublic.png", side: "right", path: "you", position: 0.58 },
 { id: "e7", title: "Graduate School", date: "2017 (C) & 2022 (M)", desc: "Both of us graduated from Columbia University five years apart from one another", icon: <Camera className="w-4 h-4" />, img: "/images/ColumbiaGrad.png", side: "left", path: "partner", position: 0.70 }, 
 { id: "e8", title: "Our Shared Story", date: "", desc: "Before meeting, we unknowingly traveled to the same places, studied in the same school, and taught in the same part of the city. When we did finally met in 2024, it was immediately apparent that our stories have always been running side by side", icon: <Heart className="w-4 h-4" />, img: "/images/FirstDate.png", side: "merge", path: "merge", position: 0.82 },
 ...
 { id: "e10", title: "We then had many wintery adventures...", date: "Winter 2024", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/WinterAdventures.png", side: "right", path: "merge", position: 0.82 },
 { id: "e11", title: "...and warmer adventures!", date: "Spring & Summer 2025", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/SummerAdventures.png", side: "left", path: "merge", position: 0.82 },
 { id: "e12", title: "We took our first trip together to Peru", date: "Apr 13–20, 2025", desc: "So much seen on so little sleep", icon: <Heart className="w-4 h-4" />, img: "/images/FirstTrip.png", side: "right", path: "merge", position: 0.82 },
 { id: "e13", title: "Our Shared Future", date: "", desc: "On July 2025, we got engaged in Central Park, surrounded by friends and family who became part of the surprise. Now, we look forward to celebrating with our loved ones at our wedding on March 2026 in Beacon, New York, and to continuing to build a life of shared adventures and laughter", icon: <Heart className="w-4 h-4" />, img: "", side: "merge", path: "merge", position: 0.82 },
 { id: "e14", title: "Central Park rowboats", date: "July 19, 2025", desc: "Photo credits to Brooke and Ryan ;)", icon: <Heart className="w-4 h-4" />, img: "/images/Proposal.png", side: "merge", path: "merge", position: 0.82 },
 { id: "e15", title: "See you there!", date: "3/29/2026 - Beacon, NY", desc: "", icon: <Heart className="w-4 h-4" />, img: "/images/Constantine&Melissa.png", side: "merge", path: "merge", position: 0.82 },
 ];
